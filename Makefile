OUT=webdis
HIREDIS_OBJ?=src/hiredis/alloc.o src/hiredis/async.o src/hiredis/dict.o src/hiredis/hiredis.o src/hiredis/net.o src/hiredis/read.o src/hiredis/sds.o src/hiredis/sockcompat.o
